...
#define BT_DIAG_LOG(...) ((void)0)
    ...
    Application::Application(int argc, char **argv) {
        ...
        try {
            ...
            runtimeRearmStartGate_ = ReadBoolParameter(*node_, "runtime_rearm_start_gate", false);
            ...
            LoggerPtr->Info("runtime_rearm_start_gate: {}", runtimeRearmStartGate_ ? "true" : "false");
        ...
        pub_navi_reach_state_= node_->create_publisher<auto_aim_common::msg::GoalReach>(ly_navi_reach_state::Name, 10);
        ...
        pub_friend_info_     = node_->create_publisher<gimbal_driver::msg::UnitInfoArray>(ly_friend_info::Name, 10);
        pub_enemy_info_      = node_->create_publisher<gimbal_driver::msg::UnitInfoArray>(ly_enemy_info::Name, 10);
        pub_sentry_position_ = node_->create_publisher<geometry_msgs::msg::PointStamped>(ly_bt_sentry_position::Name, 10);
    ...
    void Application::LogDecisionConfigurationOnce() {
        ...
        const DecisionExplain::ConfigSnapshot snapshot{
            ...
            .ProtectHeroProactiveHoldWhenHeroInHighland =
                tactical.ProtectHero.ProactiveHoldWhenHeroInHighland,
            .ProtectHeroStartElapsedSec = tactical.ProtectHero.StartElapsedSec,
            .ProtectHeroHoldSec = tactical.ProtectHero.HoldSec,
            .ProtectHeroNoEnemyReleaseSec = tactical.ProtectHero.NoEnemyReleaseSec,
            .ProtectHeroFriendPositionFreshMs = tactical.ProtectHero.FriendPositionFreshMs,
            .ProtectHeroFriendHealthFreshMs = tactical.ProtectHero.FriendHealthFreshMs,
