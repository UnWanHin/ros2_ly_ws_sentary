...
namespace ly_auto_aim::inline detector{
    class ArmorRefinder{
         ...
         */
        [[nodiscard]] bool ReFindAndSolveAll(PoseSolver& solver, const std::vector<ArmorObject>& armors, const ArmorType& target, ArmorObject& target_armor, auto_aim_common::Armors& armors_msg) noexcept;
