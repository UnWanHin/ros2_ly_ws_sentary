...
#   external /ly/aim/TargetList + /ly/aim/Result -> behavior_tree
...
Purpose:
  ...
  It waits for external aim topics:
    /ly/aim/TargetList   sentry_msgs/msg/AimTargetArray
    /ly/aim/Result       sentry_msgs/msg/AimResult
  BT publishes:
    /ly/aim/SelectTarget -> external aim
...
echo "[INFO] external aim input: /ly/aim/TargetList + /ly/aim/Result" >&2
