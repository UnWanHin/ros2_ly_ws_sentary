...
if (( $# == 0 )); then
  echo "[INFO] NaviToOfficial offline converter. input=${INPUT_UNIT}, output=${OUTPUT_UNIT}"
  echo "[INFO] Type: <navi_map_x> <navi_map_y> [z]. Type q to quit."
  while true; do
    printf '[NaviToOfficial] x y [z] > '
