...
if (( RUNTIME_ONLY == 0 )); then
  ...
  check_file_exists "${ROOT_DIR}/scripts/start_sentry_showcase.sh"
  check_file_exists "${ROOT_DIR}/scripts/launch/start_sentry_showcase.sh"
  check_file_exists "${ROOT_DIR}/scripts/start_sentry_navi_debug.sh"
  ...
  check_file_exists "${ROOT_DIR}/scripts/start_navi_patrol_test.sh"
  ...
  check_executable_file "${ROOT_DIR}/scripts/start_sentry_showcase.sh"
  check_executable_file "${ROOT_DIR}/scripts/launch/start_sentry_showcase.sh"
  check_executable_file "${ROOT_DIR}/scripts/start_sentry_navi_debug.sh"
  ...
  check_executable_file "${ROOT_DIR}/scripts/start_navi_patrol_test.sh"
  ...
  check_bash_syntax "${ROOT_DIR}/scripts/start_sentry_showcase.sh"
  check_bash_syntax "${ROOT_DIR}/scripts/launch/start_sentry_showcase.sh"
  check_bash_syntax "${ROOT_DIR}/scripts/start_sentry_navi_debug.sh"
  ...
  check_bash_syntax "${ROOT_DIR}/scripts/start_navi_patrol_test.sh"
