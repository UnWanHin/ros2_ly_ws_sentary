...
Purpose:
  Thin wrapper for behavior_tree/navi_debug.launch.py.
EOF
}
...
cleanup_existing_stack "1" "/(gimbal_driver_node|behavior_tree_node|map_aim_point_node|map_path_to_game_path_node|target_rel_to_goal_pos_node)([[:space:]]|$)" "ros2 launch (behavior_tree|navi_tf_bridge) (navi_debug|sentry_all|map_aim_point)\\.launch.py"
...
exec ros2 launch behavior_tree navi_debug.launch.py "${LAUNCH_ARGS[@]}"
