...
Purpose:
  Thin wrapper for behavior_tree/chase_only.launch.py.
  Default: online + nogate + mode=league.
...
cleanup_existing_stack "1" "/(gimbal_driver_node|behavior_tree_node|map_aim_point_node|map_path_to_game_path_node|target_rel_to_goal_pos_node)([[:space:]]|$)" "ros2 launch (behavior_tree|navi_tf_bridge) (sentry_all|competition_autoaim|showcase|chase_only|map_aim_point)\\.launch.py"
