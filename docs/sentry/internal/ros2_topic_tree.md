...
└── trajectory : gimbal_driver/msg/GimbalTrajectory [External MPC] -> DownlinkTypeID=0x05 26B
```
...
├── should_rotate : std_msgs/msg/Bool               [External] 导航 -> BT；debug_node 经 100 Hz bridge 转 /ly/control/firecode，true 恢复配置 Rotate，false 停小陀螺并可置 FollowMode
└── vel           : gimbal_driver/msg/Vel           [External] 正式经 BT 转 /ly/control/vel；debug_node 经同一 100 Hz bridge 转同一 control topic
